      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
                ...
                <tr>
                    <td>
                      <div class="shopping-cart__product-item">
                        <img loading="lazy" src="{{asset('uploads/products/thumbails')}}/{{$item->model->image}}" width="120" height="120" alt="{{$item->name}}" />
                      </div>
                    </td>
                    <td>
          ...
          <div class="cart-table-footer">
            ...
            @else
            <form action="{{route('cart.coupans.remove')}}" method="POST" class="position-relative bg-body">
              @csrf
              @method('DELETE')
        ...
        <div>
          ...
          <p class="text-success" style='color:green !important; font-weight:600; '>{{Session::get('success')}}</p>
          @elseif(Session::has('error'))
          <p class="text-danger" style='color:red !important; font-weight:600; '>{{Session::get('error')}}</p>
          @endif
        ...
        <div class="row">
            ...
            <a href="{{route('shop.index')}}" class='btn btn-info'>Shop</a>
            </div>    
        </div>    
        @endif
      </div>
