    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <select  class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" 
            aria-label="Page Size" id="orderby" name="orderby">
...
<form id="frnfilter" method="GET" action="{{ route('shop.index') }}">
...
<script>
  $(document).ready(function () {
      // Change event for page size selection
      $("#pagesize").on("change", function () {
          $("#size").val($(this).val());
          $("#frnfilter").submit();
      });

      // Change event for sorting order
      ...
      $("input[name='brands']").on("change", function () {
          let selectedBrands = $("input[name='brands']:checked").map(function () {
              return $(this).val();
          }).get().join(",");

          $("#hdnBrands").val(selectedBrands);
      ...
      $("input[name='categories']").on("change", function () {
          let selectedBrands = $("input[name='categories']:checked").map(function () {
              return $(this).val();
          }).get().join(",");
